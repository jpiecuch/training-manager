!function (a, b) {
    b["true"] = a, angular.module("textAngularSetup", []).value("taOptions", {
        toolbar: [["h1", "h2", "h3", "h4", "h5", "h6", "p", "pre", "quote"], ["bold", "italics", "underline", "ul", "ol", "redo", "undo", "clear"], ["justifyLeft", "justifyCenter", "justifyRight", "indent", "outdent"], ["html"]],
        classes: {
            focussed: "focussed",
            toolbar: "btn-toolbar",
        ...
        html: {buttontext: "Toggle HTML", tooltip: "Toggle html / Rich Text"},
        ...
        a("html", {
            buttontext: c.html.buttontext, tooltiptext: c.html.tooltip, action: function () {
        ...
        m.constant("taRegisterTool", c), m.value("taTools", n), m.config([function () {
            ...
            return {
                require: "?ngModel", scope: {}, restrict: "EA", link: function (k, l, m, n) {
