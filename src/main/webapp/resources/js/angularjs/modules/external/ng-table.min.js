        ...
        return{restrict: "A", priority: 1001, scope: !0, controller: c, compile: function (c) {
            ...
            return a.forEach(a.element(c.find("tr")), function (b) {
                ...
                if (c.$loading = !1, c.$columns = d, c.$watch(g.ngTable, function (b) {
                    ...
                    var i = h.length > 0 ? h : a.element(document.createElement("thead")).attr("ng-include", "templates.header"), j = a.element(document.createElement("tr")).append(a.element(document.createElement("td")).attr({"ng-table-pagination": "params", "template-url": "templates.pagination", colspan: '100%'})), k = a.element(document.createElement("tfoot")).append(j);
