...
angular.module('mgcrea.ngStrap.alert', ['mgcrea.ngStrap.modal'])
  ...
  .provider('$alert', function() {
    ...
    this.$get = ["$modalAS", "$timeout", function($modalAS, $timeout) {
...
angular.module('mgcrea.ngStrap.aside', ['mgcrea.ngStrap.modal'])
  ...
  .provider('$aside', function() {
    ...
    this.$get = ["$modalAS", function($modalAS) {
...
angular.module('mgcrea.ngStrap.modal', ['mgcrea.ngStrap.helpers.dimensions'])
  ...
  .provider('$modalAS', function() {
    ...
    this.$get = ["$window", "$rootScope", "$compile", "$q", "$templateCache", "$http", "$animate", "$timeout", "$sce", "dimensions", function($window, $rootScope, $compile, $q, $templateCache, $http, $animate, $timeout, $sce, dimensions) {
      ...
      function ModalFactory(config) {
        ...
        // Common vars
        var options = $modalAS.$options = angular.extend({}, defaults, config);
        $modalAS.$promise = fetchTemplate(options.template);
        var scope = $modalAS.$scope = options.scope && options.scope.$new() || $rootScope.$new();
        ...
        if(options.contentTemplate) {
          $modalAS.$promise = $modalAS.$promise.then(function(template) {
        ...
        var backdropElement = angular.element('<div class="' + options.prefixClass + '-backdrop"/>');
          $modalAS.$promise.then(function(template) {
        ...
        $modalAS.show = function() {

          if(scope.$emit(options.prefixEvent + '.show.before', $modalAS).defaultPrevented) {
            return;
          }
          var parent;
          ...
          modalElement = $modalAS.$element = modalLinker(scope, function(clonedElement, scope) {});
          ...
          if(options.keyboard) {
            modalElement.on('keyup', $modalAS.$onKeyUp);
          }
        };

        function enterAnimateCallback() {
          scope.$emit(options.prefixEvent + '.show', $modalAS);
        }

        $modalAS.hide = function() {

          if(scope.$emit(options.prefixEvent + '.hide.before', $modalAS).defaultPrevented) {
            return;
          }
          ...
          if(options.keyboard) {
            modalElement.off('keyup', $modalAS.$onKeyUp);
          }
        };

        function leaveAnimateCallback() {
          scope.$emit(options.prefixEvent + '.hide', $modalAS);
        ...
        $modalAS.toggle = function() {

          scope.$isShown ? $modalAS.hide() : $modalAS.show();

        };

        $modalAS.focus = function() {
          modalElement[0].focus();
        };

        // Protected methods

        $modalAS.$onKeyUp = function(evt) {
        ...
        function hideOnBackdropClick(evt) {
          ...
          options.backdrop === 'static' ? $modalAS.focus() : $modalAS.hide();
        }
  ...
  .directive('bsModal', ["$window", "$sce", "$modalAS", function($window, $sce, $modalAS) {
