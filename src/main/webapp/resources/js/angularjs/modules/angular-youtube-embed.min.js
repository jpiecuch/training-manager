angular.module("youtube-embed", ["ng"]).run(function () {
...
}).service("$youtube", ["$window", "$rootScope", function (e, t) {
    function n(e, t) {
    ...
    var a = /https?:\/\/(?:[0-9A-Z-]+\.)?(?:youtu\.be\/|youtube(?:-nocookie)?\.com\S*[^\w\s-])([\w-]{11})(?=[^\w-]|$)(?![?=&+%\w.-]*(?:['"][^<>]*>|<\/a>))[?=&+%\w.-]*/gi, d = /t=(\d+)[ms]?(\d+)?s?/, u = {ready: !1, playerId: null, player: null, videoId: null, playerHeight: "390", playerWidth: "640", currentState: null, setURL: function (e) {
    ...
    return{restrict: "EA", scope: {videoId: "=", videoUrl: "="}, link: function (t, n) {
        e.playerId = n[0].id;
