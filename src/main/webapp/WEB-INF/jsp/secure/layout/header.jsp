...
<div class="page-header navbar navbar-fixed-top">
    <div class="page-header-inner">
        ...
        <div style="margin-left: 10px" class="hor-menu hor-menu-light hidden-sm hidden-xs">
                <ul class="nav navbar-nav">
                        <li class="classic-menu-dropdown ${fn:endsWith(requestScope['javax.servlet.forward.request_uri'], '/index.html') or requestScope['javax.servlet.forward.request_uri'] eq fullContextPath  ? 'active' : ''}">
                                <a href="<c:url value="/"/>">
                                         <spring:message code="app.name"/><span class="selected"></span>
                                </a>
                        </li>
        ...
        <sec:authentication property="principal.type"/>
        <!-- END HORIZANTAL MENU -->
        <div class="top-menu">
