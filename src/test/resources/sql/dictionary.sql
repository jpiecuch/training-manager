...
INSERT INTO description (id, name, movie_url, description, party_muscles, type, equipment, level, mechanics, force, sides, sets) VALUES (5, '{"pl":"pl_5","en":"en_5"}', 'url_5', '<h1>test 5</h1>', 11, 3, NULL, 1, 0, 0, 1, 1);
